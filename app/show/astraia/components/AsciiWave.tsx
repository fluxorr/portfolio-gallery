...
export default function AsciiWave() {
    ...
    return (
        <pre
            ref={canvasRef}
            className="absolute flex items-center justify-center  w-screen h-screen overflow-hidden font-mono text-xs text-neutral-500  select-none pointer-events-none -z-50"
            style={{
