...
const Navbar = () => {
    return (
        <nav className=" bg-neutral-400/20 backdrop-blur-sm sticky  top-0" >
            <div className="flex items-center justify-between mx-auto max-w-[80vw] py-4 " >
                <div className="flex flex-row items-center gap-2 text-lg font-semibold" >
                    <Logo />
                    <p>Archiviz</p>
                </div>
                <div className="flex flex-row gap-8 text-sm text-neutral-400" >
                ...
                <div className="flex flex-row gap-8" >
                    <button className="cursor-pointer tracking-tighter font-extralight" >Log In </button>
